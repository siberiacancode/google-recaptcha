...
| `render`             | `(container: Container, parameters?: GoogleReCaptcha.Parameters, inherit?: boolean) => number \| undefined` | Renders the reCAPTCHA widget and returns its widget id.                                                  |
